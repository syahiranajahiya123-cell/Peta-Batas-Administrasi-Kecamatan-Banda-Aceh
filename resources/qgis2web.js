...
map.getView().fit([10596266.660517, 610181.529859, 10628177.999644, 631886.132555], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Peta Batas Administrasi Kecamatan Banda Aceh</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (89 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Peta ini memberikan informasi terkait batas administrasi Kecamatan yang ada di Banda Aceh';
            }
